import { SafeAreaView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View,Image,Linking } from 'react-native'
       ...
       {({
         ...
         <View style={styles.formActions}>
          ...
          <View>
           ...
           <Text style={styles.description}>Long Press to Copy/Share</Text>
